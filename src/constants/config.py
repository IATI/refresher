...
config = dict(DATA_SCHEMA = "public",
    ...
    VALIDATION = dict(
        ...
        SCHEMA_VALIDATION_URL = os.getenv('SCHEMA_VALIDATOR_API_URL'),
        FILE_VALIDATION_KEY_NAME = os.getenv('VALIDATOR_API_KEY_NAME'),
        FILE_VALIDATION_KEY_VALUE = os.getenv('VALIDATOR_API_KEY_VALUE'),
        SCHEMA_VALIDATION_KEY_NAME = os.getenv('SCHEMA_VALIDATOR_API_KEY_NAME'),
        SCHEMA_VALIDATION_KEY_VALUE = os.getenv('SCHEMA_VALIDATOR_API_KEY_VALUE'),
        ALV_THRESHOLD = 1000,
        ALV_PERIOD = 24
    ),
    FLATTEN = dict(

...
def test_recursive_json_nest(filename):
    xml_filename = os.path.join(
        os.path.dirname(os.path.realpath(__file__)), "fixtures_lakify_recursive_json_nest", filename + ".input.xml"
    )
    json_filename = os.path.join(
        os.path.dirname(os.path.realpath(__file__)), "fixtures_lakify_recursive_json_nest", filename + ".expected.json"
    )
